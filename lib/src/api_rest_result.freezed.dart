...
mixin _$APIResult {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiRestError error) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(ApiRestError error)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Error implements APIResult {
  const factory Error(final ApiRestError error) = _$Error;

  ApiRestError get error;
  @JsonKey(ignore: true)
